...
Source0:        https://github.com/lunovpn/lunowg-tools/archive/refs/tags/v%{version}.tar.gz
...
%{_bindir}/lwg
%{_bindir}/lwg-quick
%{_sysconfdir}/lunovpn/wg/
%{_datadir}/bash-completion/completions/lwg
%{_datadir}/bash-completion/completions/lwg-quick
%{_unitdir}/lwg-quick@.service
%{_unitdir}/lwg-quick.target
%{_mandir}/man8/lwg.8*
%{_mandir}/man8/lwg-quick.8*
